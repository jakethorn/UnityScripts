...
namespace Jake.Reflection
{
	...
	public class Data
	{
		...
		public bool IsValid
		{
			get
			{
				if (((source == Source.Field || source == Source.Method || source == Source.Property) && gameObject == null) ||
					(source == Source.Inspector && (type == DataType.Camera || type == DataType.Texture2D) && Value == null))
				{
					return false;
				}
				else
		...
		{
			Debug.Assert(source == Source.Method, "Data does not represent a method");
