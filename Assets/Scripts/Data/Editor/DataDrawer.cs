...
namespace Jake.Reflection
{
	...
	public class DataDrawer : FieldDrawer
	{
		...
		{
			// get shared data
			//if (sharedData.ContainsKey("offset"))
			//{
			//	position.y += (float)sharedData["offset"] - LineHeight;
			//	sharedData.Remove("offset");
			//}
			...
			// set shared data
			//sharedData["method_title"] = GetTitle();
		}
